...
const T = {
  es: {
    tutorial: 'Ayuda/Tutorial', playerManual: 'Manual del Jugador',
    facilitators: 'Facilitadores', equations: 'Ecuaciones',
    facilitatorPanel: 'Panel Facilitador',
    abandon: 'Abandonar', gameOver: 'JUEGO TERMINADO',
    levelLabel: 'Nivel', yearLabel: 'Año', scoreLabel: 'Puntaje',
    currentFocus: 'Enfoque Actual',
    setLevel: (n: number) => `Fijar Nivel ${n}`,
    alreadyAt: (n: number) => `Ya estás en el Nivel ${n}`,
    levelBtn: (n: number) => `Nvl ${n}`,
    langBtn: 'English', langFlag: '🇬🇧',
  },
  en: {
    tutorial: 'Help/Tutorial', playerManual: "Player's Manual",
    facilitators: 'Facilitators', equations: 'Equations',
    facilitatorPanel: 'Facilitator Panel',
    abandon: 'Abandon', gameOver: 'GAME OVER',
    levelLabel: 'Level', yearLabel: 'Year', scoreLabel: 'Score',
    currentFocus: 'Current Focus',
    setLevel: (n: number) => `Set Level ${n}`,
    alreadyAt: (n: number) => `Already at Level ${n}`,
    levelBtn: (n: number) => `Lvl ${n}`,
    langBtn: 'Español', langFlag: '🇦🇷',
  },
} as const;
      ...
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center">
        ...
        <div className="flex space-x-4 sm:space-x-6 items-center">
          ...
          <button
            ...
            className="text-gray-400 hover:text-gray-200 text-sm ml-2 focus:outline-none focus:ring-1 focus:ring-gray-400 rounded"
